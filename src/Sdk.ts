import { Authentication, Carbon, Iban, Transport, User, CarbonStatistics } from './resources';
...
export class Sdk {
    ...
    constructor(configObject?: IConfig) {
        ...
        this.carbonStatistics = new CarbonStatistics(this._tokens, this._identity, this._host);
    }
